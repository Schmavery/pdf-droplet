...
const OP_DOCS: Record<string, DocEntry> = {
  ...
  EMC: {
    type: "markedcontent",
    label: "End marked content",
    doc: "end marked content",
  },
  DP: {
    type: "state",
    label: "Marked content point",
  ...
  CS: {
    type: "color",
    label: "Stroke color space",
    doc: "set stroke color space",
    args: ["name"],
  },
  cs: {
    type: "color",
  ...
  SCN: {
    type: "color",
    label: "Stroke color",
    doc: "set stroke color (pattern/ICCBased)",
  },
  scn: {
    type: "color",
    label: "Fill color",
    doc: "set fill color (pattern/ICCBased)",
  },
  G: {
    type: "color",
    label: "Stroke gray",
  ...
  RG: {
    type: "color",
    label: "Stroke color (RGB)",
    doc: "set stroke RGB",
    args: ["r", "g", "b"],
  },
  rg: {
    type: "color",
    label: "Fill color (RGB)",
    doc: "set fill RGB",
    args: ["r", "g", "b"],
  },
  K: {
  ...
  // paths
  m: { type: "path", label: "Move to", doc: "move to", args: ["x", "y"] },
  l: { type: "path", label: "Line to", doc: "line to", args: ["x", "y"] },
  c: {
    type: "path",
  ...
  v: {
    type: "path",
    label: "Bézier (1st ctrl pt)",
    doc: "curve (copy first control)",
    args: ["x2", "y2", "x3", "y3"],
  },
  y: {
    type: "path",
    label: "Bézier (2nd ctrl pt)",
    doc: "curve (copy second control)",
    args: ["x1", "y1", "x3", "y3"],
  },
  h: { type: "path", label: "Close subpath", doc: "close subpath" },
  re: {
    type: "path",
    label: "Rectangle",
    doc: "rectangle",
  ...
  B: {
    type: "paint",
    label: "Fill & stroke",
    doc: "fill, then stroke",
    detail: "Fill is non-zero",
  },
  "B*": {
    type: "paint",
    label: "Fill & stroke (EO)",
    doc: "fill, then stroke",
    detail: "Fill is even-odd",
  },
  b: {
    type: "paint",
    label: "Close, fill, stroke",
    doc: "close, fill, stroke",
    detail: "Fill is non-zero",
  },
  "b*": {
    type: "paint",
    label: "Close, fill, stroke (EO)",
  ...
  Tc: {
    type: "text",
    label: "Char spacing",
    doc: "set char spacing",
    args: ["spacing"],
  },
  Tw: {
    type: "text",
    label: "Word spacing",
    doc: "set word spacing",
    args: ["spacing"],
  },
  Tz: {
    type: "text",
    label: "Horiz scaling",
    doc: "set horiz scaling %",
    args: ["scale"],
  },
  TL: {
    type: "text",
  ...
  Td: {
    type: "text",
    label: "Text position",
    doc: "set text position",
    args: ["tx", "ty"],
  },
  TD: {
    type: "text",
    label: "Text pos & leading",
  ...
  "T*": { type: "text", label: "Next line", doc: "move to next line" },
  Tf: {
    type: "text",
    label: "Text font",
    doc: "set font",
  ...
  Tj: { type: "showtext", label: "Show text", doc: "show text" },
  TJ: {
    type: "showtext",
    label: "Show text (array)",
    doc: "show text",
    detail: "Array of strings and kerning numbers",
  },
  "'": {
    type: "showtext",
    label: "Next line + show",
    doc: "next line + show",
    detail: "Equivalent to T* followed by Tj",
  },
  '"': {
    type: "showtext",
    label: "Set spacing + show",
